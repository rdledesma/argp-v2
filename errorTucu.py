...
df = Geo(freq='15', lat=-26.82, long=-65.21, gmt=-3).df

salta  = promedio.prom('./Data/tucu.csv')
...
df['GHIargp2'] = df.apply(lambda r: generateGHIcc(r['TOA'], r['Mak'], miKTRP(453)), axis=1)
