...
class Geo:
    ...
    def __init__(self, freq, lat, long, gmt, altitud ):
        self.gmt = gmt
        self.lat = lat
        self.long = long
        self.altura = altitud
...
df = Geo(freq='15', lat=-26.84, long=-65.69, gmt=-3, altitud=2488).df

salta  = promedio.prom('./Data/tilcara.csv')
...
df['GHIargp2'] = df.apply(lambda r: generateGHIcc(r['TOA'], r['Mak'], miKTRP(2488)), axis=1)
