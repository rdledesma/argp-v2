...
df = Geo(freq='15', lat=-24.6, long=-65.38, gmt=-3).df

ero  = promedio.prom('./Data/lacaldera.csv')
ero['TOA'] = ero['TOA'] *4
...
dfMin['lacaldera'] = minKtErrors
dfMin.to_csv('lacalderaMin.csv',sep=";", index=False)
