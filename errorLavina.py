...
df = Geo(freq='15', lat=-25.46, long=-65.56, gmt=-3).df

salta  = promedio.prom('./Data/laviña.csv')
...
df['GHIargp2'] = df.apply(lambda r: generateGHIcc(r['TOA'], r['Mak'], miKTRP(1265)), axis=1)
