...
df = Geo(freq='15', lat=-34.5, long=-56, gmt=-3).df

lujan  = promedio.prom('./Data/montevideo.csv')
lujan['TOA'] = lujan['TOA'] *4
lujan['Clear sky GHI'] = lujan['Clear sky GHI'] *4


lujan['TOA'] = lujan['TOA'].shift(-12)
lujan['Clear sky GHI'] = lujan['Clear sky GHI'].shift(-12)
lujan.fillna(0, inplace=True)
df['GHImc'] = lujan['Clear sky GHI'].copy()
