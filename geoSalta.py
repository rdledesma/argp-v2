...
df = Geo(freq='15', lat=-24.7, long=-65.4, gmt=-3).df

salta  = promedio.prom('./Data/salta.csv')
...
ktrs = np.arange(0.55, 0.9999, 0.0001)
minKtErrors = []
arrayDia = []
arrayKtr = []
arrayMSE = []
...
dfMin['Salta'] = minKtErrors
dfMin.to_csv('saltaMin.csv',sep=";", index=False)
